...
## Tabel Ringkasan Risiko dan Mitigasi

| Risiko | Contoh Dampak | Cara Mitigasi |
|---|---|---|
| Halusinasi | Informasi salah dianggap benar | Verifikasi dengan sumber tepercaya |
| Bias algoritma | Diskriminasi tidak disengaja | Audit sistem, keberagaman data pelatihan |
| Privasi data | Kebocoran informasi sensitif | Hindari input data rahasia/pribadi |
| Ketergantungan berlebihan | Menurunnya kemampuan berpikir mandiri | Gunakan AI sebagai alat bantu, bukan pengganti |
| Dampak pekerjaan | Pergeseran kebutuhan keterampilan | Belajar keterampilan baru secara berkelanjutan |

!!! warning "Ingat"
    Tidak ada sistem AI yang sempurna atau bebas kesalahan. Sikap kritis dan kebiasaan verifikasi adalah bagian inti dari literasi AI yang baik — bukan tanda tidak percaya pada teknologi, melainkan bentuk penggunaan yang bertanggung jawab.
